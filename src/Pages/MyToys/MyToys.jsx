...
const MyToys = () => {
    ...
    const toyPerPage = 20;
    const myToysUrl = `https://assignment-11-server-psi-ten.vercel.app/sellerToys/${user?.email}?page=${currentPage}&limit=${toyPerPage}`;
    const highToLowUrl = `https://assignment-11-server-psi-ten.vercel.app/sellerToys/highToLow/${user?.email}`;
    const lowToHigh = `https://assignment-11-server-psi-ten.vercel.app/sellerToys/lowToHigh/${user?.email}`;
    const searchUrl = `https://assignment-11-server-psi-ten.vercel.app/searchToys/${searchText}/${user?.email}?page=${currentPage}&limit=${toyPerPage}`;
    useEffect(() => {
    ...
    const handleUpdateToy = (event) => {
        ...
        fetch(`https://assignment-11-server-psi-ten.vercel.app/sellerToy/${toyId}`, {
            method: "PUT",
            headers: {
    ...
    const handleDelete = (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                fetch(`https://assignment-11-server-psi-ten.vercel.app/toys/${id}`, {
                    method: "DELETE"
                })
                    .then(res => res.json())
                    .then(data => {
